...
- [ ] **阶段1：分带重新比例化（地基）**
  ...
  - CHESS_PLAZA 移入新公园
- [x] **阶段2：建筑改造（混合用途连续街墙 + 单行道缺口）**
  - 4–5 层：底层店铺（超市/咖啡/银行/便利店/健身房/书店/水果店/汉堡店/诊所/餐厅），招牌抽象图标区分
  - 上层居民阳台：绿植/晾衣绳/空调外机（灰度）
  - 连续街墙（15 栋齐平底边），缺口在 x≈560–660 与 1380–1480 作侧路
  - 已重写 scene.json buildings + BuildingEntity（facadeH 可覆盖→天际线起伏）
- [ ] **阶段3：公园内容**
