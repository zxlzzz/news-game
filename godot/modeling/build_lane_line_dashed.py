"""虚线段. Original procedural model; metres, +Y up, +Z front.
...
P = {'width': 0.12, 'length': 6, 'dashes': True, 'dash_l': 1.2, 'dash_centers': (-2.4, 0, 2.4), 'lift': 0.003}
