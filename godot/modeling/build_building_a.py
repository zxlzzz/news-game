...
OUTPUT = Path(__file__).resolve().parents[1] / 'models' / 'building_a.glb'
...
def build():
    ...
    box('roof_coping', (WIDTH + 2 * CORNICE_OUT, CORNICE_H, DEPTH + 2 * CORNICE_OUT),
        (0, WALL_H + PARAPET_H + CORNICE_H / 2, -DEPTH / 2), 'trim')
    export()
