// Writes npc/mapping_reference.json for `main.gd --check-mapping`: the accepted mapping, imported from
...
// (in sth/godot-npc) node tools/make_mapping_reference.mjs --mapping ../motion-study/skeleton-mapping.mjs
